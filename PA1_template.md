...
```r
meanMedian <- data.frame( NAs.filed = c(meanStepsNa, medianStepsNa), NAs.removed = c(meanSteps, medianSteps), row.names = c("mean", "median"))
meanMedian
```
...
```
## Warning in wday(structure(c(15614, 15615, 15616, 15617, 15618, 15619,
## 15620, : longer object length is not a multiple of shorter object length
